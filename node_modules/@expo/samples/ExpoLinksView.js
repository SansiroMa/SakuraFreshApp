    ...
    this.data = [
      {
        ...
        description: 'At Sakura, we’re on a mission to change the food system for the better. Ultimately, everything we do starts with our farmers. ',
        // lineColor:'#009688', 
        ...
        imageUrl: require('./assets/images/timeline/tomato.jpeg')
      ...
      },
      {
        ...
        imageUrl: require('./assets/images/timeline/freshware.jpg')
      },
      {
        time: '2018/08/02', 
        title: 'Pack Finished', 
        ...
        imageUrl: require('./assets/images/timeline/tomaatjes2.jpg')
      ...
      },
      {
        ...
        imageUrl: require('./assets/images/timeline/logistics.jpg')
      },
      {
        time: '2018/08/03', 
        title: 'Retailer', 
        ...
        imageUrl: require('./assets/images/timeline/retail.jpg')
      },
      {
        time: '2018/08/04', 
        title: 'Consumer', 
        ...
        imageUrl: require('./assets/images/timeline/tomato_salad.jpeg')
      }
    ]
    this.state = 
    {
      ...
      description: null,
      // imageUrl:' ',
      imageUrl:require('./assets/images/slack-icon.png'),
      barCode:null,
      ...
      timeLineBody = (
          <View style={styles.timeLinecontainer}>
            ...
            >
              ...
              <View style = {styles.popupBodyContainer}>   
                    <View style = {styles.containerDetailPage}>   
                      ...
                      <Image source={this.state.imageUrl} style={styles.imageDetailPage}/>
            ...
            <Timeline 
              ...
              timeContainerStyle={{minWidth:85, marginTop: -5}}
