...
import { SectionList, Image, StyleSheet, Text, View,  AsyncStorage,Alert } from 'react-native';
...
export default class ExpoConfigView extends React.Component {
  ...
  render() {
    ...
    let singOutButton = (
      <View style = {styles.buttonContainerSettingPage}> 
        <Button
            icon={{name: 'sign-out', type: 'font-awesome'}}
            buttonStyle={styles.logoutButtonStyleSettingPage}
    ...
    let logInButton = (
      <View style = {styles.buttonContainerSettingPage}> 
        <Button
            ...
            buttonStyle={styles.loginButtonStyleSettingPage}
            // onPress={this._signOutAsync}
    ...
    {
      visiableButton=singOutButton;
    }
    else
    {
      visiableButton=logInButton;
    }
